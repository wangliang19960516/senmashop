...
<div class="container">
	...
	<table class="table table-bordered table-hover">
		...
		<tr>
			...
			<th width="10%" style="width: 10%;text-align: center;">商品数量</th>
			<th width="10%" style="width: 10%;text-align: center;">商品总价</th>
			<th width="10%" style="width: 10%;text-align: center;">订单状态</th>
			<th width="10%" style="width: 10%;text-align: center;">下单用户</th>
			<th width="10%" style="width: 10%;text-align: center;">下单时间</th>
			<th width="10%" style="width: 10%;text-align: center;">操作</th>
		</tr>
		
		<c:forEach var="indent" items="${indentList}">
	         <tr>
	         	<td style="width: 10%;text-align: center;"><p>${indent.id}</p></td>
	         	<td style="width: 10%;text-align: center;"><p>${indent.amount}</p></td>
	         	<td style="width: 10%;text-align: center;"><p>${indent.total}</p></td>
	         	...
	         	<td style="width: 10%;text-align: center;"><p>${indent.user.username}</p></td>
	         	<td style="width: 10%;text-align: center;"><p>${indent.systime}</p></td>
				<td >
