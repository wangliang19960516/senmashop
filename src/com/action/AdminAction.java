...
public class AdminAction extends PrimaryAction{
	...
	public String userReset(){
		...
		u.setPassword(StringUtils.isEmpty(user.getPassword()) ? u.getPassword() : user.getPassword());
		u.setPayword(StringUtils.isEmpty(user.getPayword()) ? u.getPayword() : user.getPayword());
	...
	public String adminReset(){
		...
		a.setPassword(StringUtils.isEmpty(admin.getPassword()) ? a.getPassword() : admin.getPassword());
